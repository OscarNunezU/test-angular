...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-pages-home-home-module"], {
  ...
  function srcAppComponentsPagesHomeHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _productos_producto_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function HomeComponent_td_16_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HomeComponent_td_16_Template_button_click_1_listener() {
          ...
          return ctx_r14.view_producto(producto_r13);
        });
    ...
    var HomeComponent = /*#__PURE__*/function () {
      function HomeComponent(productoSvc, dialog) {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.productoSvc.getAllProductos().subscribe(function (productos) {
            return _this.dataSource.data = productos;
          });
        }
      }, {
        key: "ngAfterViewInit",
        ...
        key: "view_producto",
        value: function view_producto(producto) {
          console.log('view product');
          this.openDialog(producto);
        }
      }, {
        key: "openDialog",
        value: function openDialog(producto) {
          var config = {
            data: {
          ...
          var dialogRef = this.dialog.open(_shared_components_modal_modal_component__WEBPACK_IMPORTED_MODULE_4__["ModalComponent"], config);
    ...
    HomeComponent.ɵfac = function HomeComponent_Factory(t) {
      return new (t || HomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_productos_producto_service__WEBPACK_IMPORTED_MODULE_5__["ProductoService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_6__["MatDialog"]));
    };
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](HomeComponent, [{
        ...
        return [{
          type: _productos_producto_service__WEBPACK_IMPORTED_MODULE_5__["ProductoService"]
        }, {
  ...
  function srcAppSharedComponentsModalModalComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ModalComponent = /*#__PURE__*/function () {
      function ModalComponent(dialog, // tslint:disable-next-line: align
      data) {
    ...
    ModalComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 68,
      vars: 14,
      consts: [[1, "card", 2, "width", "18rem"], ["alt", "...", 1, "card-img-top", 3, "src"], [1, "card-body"], [1, "card-title"], [1, "table"], [1, "td_label"], [1, "td_info"]],
